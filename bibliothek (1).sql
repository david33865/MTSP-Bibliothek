...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 12. Jan 2026 um 22:09
...
(14, 2, '123', 1, '2026-01-12', NULL, 'ausgeliehen');
...
('123', 'test', 'test', NULL, NULL, 1.00, 'ausgeliehen'),
...
--
ALTER TABLE `ausleihen`
  MODIFY `ausleihen_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
